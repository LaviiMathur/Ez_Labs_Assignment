...
function Portfolio() {
  return (
    <section
      id="portfolio"
      className="p-2.5 snap-start min-w-screen min-h-screen py-20 laptop:py-0 laptop:px-[26px] flex flex-col laptop:flex-row justify-around tablet:justify-evenly items-center relative"
    >
      {/* Camera Image */}
      <img
        src="/assets/portfolio/Cam.svg"
        alt="camera"
        className="hidden tablet:block w-[225px] right-4/5 absolute -z-10"
      />
      <div className="flex flex-col items-center ">
        ...
        <div className="relative top-20">
          <img src="/assets/portfolio/portfolio.svg" alt="video" className="tablet:w-[980px] " />
          <img
      ...
      {/* bottom circle */}
      <img
        src="public/assets/Footerircle.svg"
        alt="footercircle"
