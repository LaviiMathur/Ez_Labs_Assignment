    ...
    >
      <img
        ...
        className=" hidden laptop:block absolute tablet:left-10 laptop:left-20
         bottom-10  tablet:w-[350px]  laptop:w-[442px]"
        alt="Indiagate image"
      />
      <div className="absolute top-20 laptop:top-5 laptop:left-48  tablet:-rotate-10 tablet:w-[500px] laptop:w-[620px] flex flex-col items-center gap-4 text-center">
        <img
          src="/assets/team/paperClip.svg"
          alt="paper clip"
          className="w-[680px]"
        />
        <p className="absolute p-10 laptop:p-20 z-10 text-[18px] tablet:text-[24px] text-left  tracking-wide font-sub-heading leading-tight">
